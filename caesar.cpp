...
//        XMLElement * actElement = doc->FirstChildElement("PLAY")->FirstChildElement("ACT")->FirstChildElement("TITLE");
...
//To print Act of the play
    ...
    //To print the Scene of the play
       ...
       std::cout<<
        pRoot->FirstChildElement("ACT")->FirstChildElement("SCENE")->FirstChildElement("TITLE")->NextSiblingElement("SPEECH")->GetText()<<std::endl;
